function darkMode(){const e=window.matchMedia("(prefers-color-schema: dark)");e.matches?document.body.classList.add("dark-mode-boton"):document.body.classList.remove("dark-mode-boton"),e.addEventListener("change",(function(){e.matches?document.body.classList.add("dark-mode-boton"):document.body.classList.remove("dark-mode-boton")}));document.querySelector(".dark-mode-boton").addEventListener("click",(function(){document.body.classList.toggle("dark-mode-boton")}))}function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",navegacionResponsive)}function navegacionResponsive(){document.querySelector(".navegacion").classList.toggle("mostrar")}
